      ...
      <div className="bg-background min-h-screen pb-40">
        <div className="max-w-[1400px] mx-auto px-6 pt-6">
          <div className="flex flex-col gap-4 mb-10">
            <div className="flex items-center justify-between w-full">
               ...
               <div className="inline-flex items-center gap-3 px-4 py-2 bg-slate-900/40 rounded-2xl border border-slate-800/50 backdrop-blur-md">
                  ...
                  <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Tactical Link</span>
               </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              { label: "Safety Index", value: "98", unit: "/100", color: "text-teal-500", bg: "bg-teal-500/10", icon: Shield },
              { label: "Node Guardians", value: "3", unit: " Active", color: "text-blue-500", bg: "bg-blue-500/10", icon: Users },
              { label: "Signal Density", value: "High", unit: "", color: "text-slate-100", bg: "bg-slate-800/40", icon: Radio },
              { label: "Vault Status", value: "Locked", unit: "", color: "text-indigo-400", bg: "bg-indigo-500/10", icon: Clock },
            ].map((stat, i) => (
              <motion.div 
                key={stat.label} 
